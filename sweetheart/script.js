...
// =========================================================
// POST-DATE REVIEW — THE SWEETHEART / ANIMATION V1
...
reviewPanel.addEventListener('change', (event) => {
  ...
  pill.animate([
    ...
    { transform: 'scale(1.08)', boxShadow: '0 0 32px rgba(211,148,173,.38)' },
    { transform: 'scale(1)', boxShadow: '0 0 18px rgba(194,125,151,.18)' }
...
reviewForm.addEventListener('submit', async (event) => {
  ...
  const payload = {
    ...
    book: window.currentDateConfig?.book?.title || "Swordheart",
    author: window.currentDateConfig?.book?.author || "T. Kingfisher",
  ...
  try {
    ...
    submitReview.textContent = '♡ SEND THE LOVE LETTER ♡';
    reviewStatus.textContent = 'The love-letter chute jammed. Please try again.';
  }
});
