...
// POST-DATE REVIEW — THE ARISTOCRATIC ASSHOLE / ANIMATION V1
...
reviewPanel.addEventListener('change', (event) => {
  ...
  pill.animate([
    ...
    { transform: 'scale(1.08)', boxShadow: '0 0 32px rgba(241,207,121,.40)' },
    { transform: 'scale(1)', boxShadow: '0 0 18px rgba(173,32,53,.20)' }
...
reviewForm.addEventListener('submit', async (event) => {
  ...
  try {
    ...
    submitReview.textContent = '♛ FILE THE COMPLAINT ♛';
    reviewStatus.textContent = 'Palace bureaucracy ate your complaint. Please try again.';
  }
});
