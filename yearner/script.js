...
// =========================================================
// POST-DATE REVIEW — THE YEARNER / ANIMATION V2
...
reviewPanel.addEventListener('change', (event) => {
  ...
  pill.animate([
    ...
    { transform: 'scale(1.08)', boxShadow: '0 0 32px rgba(180,198,255,.34)' },
    { transform: 'scale(1)', boxShadow: '0 0 18px rgba(180,198,255,.14)' }
